...
print "Exercised salary options maximum: ", max_salary, " minimum: ", min__salary

print "Rescaled stock:\n", float(1000000-min_stock)/(max_stock-min_stock), "\n"
print "\nRescaled salary:\n", float(200000-min__salary)/(max_salary-min__salary), "\n"
